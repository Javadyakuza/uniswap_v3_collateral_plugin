...
interface IRewardable {
  ...
  /// @custom:interaction
  function claimRewards(/*IUNI_V3_POS_Wrapper IUNI_V3_POS_WrapperClaimer, uint256 _positionId, address _recepient*/) external;// {
  // IUNI_V3_POS_WrapperClaimer.claimReward(_positionId, _recepient); 
  // }
}
